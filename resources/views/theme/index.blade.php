                ...
                <div class="layui-card">
                    <div class="layui-card-header">
                        <div class="pull-right">
                            <a href="{{ url('/theme/create') }}" class="layui-btn layui-btn-sm" >新建投票</a>
                        </div>
                    </div>
                    <div class="layui-card-body">
                        ...
                        <script type="text/html" id="barDemo">
                            <a class="layui-btn layui-btn-sm"  lay-event="detail">投票信息</a>
                            <a class="layui-btn layui-btn-sm"  lay-event="option">选项设置</a>
